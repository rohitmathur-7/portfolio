			...
			<div className="mx-auto max-w-6xl px-6 py-12">
				<div className="flex flex-col md:flex-row items-center justify-between gap-8">
					...
					>
						<a
							href="#"
							className="text-2xl font-bold tracking-tighter inline-block mb-2"
						>
					...
					>
						{siteConfig.nav.map((item) => (
							<a
								key={item.href}
								href={item.href}
								className="text-xs text-muted hover:text-foreground transition-colors duration-300 relative group"
							>
								{item.label}
